...
func TestExpectedApplicationsUseDirectProvider(t *testing.T) {
	directApplications := map[string]InstallerType{
		...
		"brave":                    InstallerTypeExecutable,
		"opera-gx":                 InstallerTypeExecutable,
		"telegram":                 InstallerTypeExecutable,
		"git":                      InstallerTypeExecutable,
		"insomnia-rest-api-client": InstallerTypeExecutable,
		"mongodb-compass":          InstallerTypeMSI,
		"powershell-core":          InstallerTypeMSI,
		"obs-studio":               InstallerTypeExecutable,
		"screentogif":              InstallerTypeMSI,
		"flameshot":                InstallerTypeMSI,
		"prismlauncher":            InstallerTypeExecutable,
		"sunshine":                 InstallerTypeMSI,
		"powertoys":                InstallerTypeExecutable,
		"notepadplusplus":          InstallerTypeExecutable,
		"bitwarden":                InstallerTypeExecutable,
		"tailscale":                InstallerTypeMSI,
		"localsend":                InstallerTypeExecutable,
	}
...
func TestKnownPackageDetectionMetadata(t *testing.T) {
	...
	examples := map[string]struct {
		...
		"opera-gx":                   {method: DetectRegistry, value: "Opera GX Stable"},
		...
		"git":                        {method: DetectRegistry, value: "Git version"},
		...
		"insomnia-rest-api-client":   {method: DetectRegistry, value: "Insomnia"},
		"mongodb-compass":            {method: DetectRegistry, value: "MongoDB Compass"},
		"screentogif":                {method: DetectRegistry, value: "ScreenToGif"},
		"flameshot":                  {method: DetectRegistry, value: "Flameshot"},
		"steam":                      {method: DetectRegistry, value: "Steam"},
		"prismlauncher":              {method: DetectRegistry, value: "Prism Launcher"},
		"sunshine":                   {method: DetectRegistry, value: "Sunshine"},
		"localsend":                  {method: DetectRegistry, value: "LocalSend"},
