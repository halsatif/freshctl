	...
	return []Category{
		...
		},
		{
			...
			Apps: []Package{
				...
				{Name: "TeamSpeak", PackageID: "teamspeak", CategoryType: "communication", Description: "Voice chat client for groups and communities."},
			...
			Categories: []Category{
				{
					...
					Apps: []Package{
						...
						{Name: "Zed", PackageID: "zed", CategoryType: "editor", Description: "Fast collaborative code editor."},
				...
				},
				{
					...
					Categories: []Category{
						...
						},
						{
							...
							Apps: []Package{
								{Name: "VC++ Redist 2005 x86/x64", PackageID: "vcredist2005", CategoryType: "runtime", Description: "Microsoft Visual C++ 2005 runtime components for x86 and x64 applications."},
								{Name: "VC++ Redist 2008 x86/x64", PackageID: "vcredist2008", CategoryType: "runtime", Description: "Microsoft Visual C++ 2008 runtime components for x86 and x64 applications."},
								...
								{Name: "VC++ Redist 2015 x86/x64", PackageID: "vcredist2015", CategoryType: "runtime", Description: "Microsoft Visual C++ 2015 runtime components for x86 and x64 applications."},
								{Name: "VC++ Redist 2017 x86/x64", PackageID: "vcredist2017", CategoryType: "runtime", Description: "Microsoft Visual C++ 2017 runtime components for x86 and x64 applications."},
								{Name: "VC++ Redist 2015-2026 x86/x64", PackageID: "vcredist140", CategoryType: "runtime", Description: "Current Microsoft Visual C++ runtime components for x86 and x64 applications, covering Visual Studio 2015 through 2026."},
							},
						},
					},
				},
		...
		},
		{
			...
			Apps: []Package{
				...
				{Name: "Faceit AC", PackageID: "faceit", CategoryType: "gaming", Description: "Faceit client and anti-cheat."},
				{Name: "Nvidia Broadcast", PackageID: "nvidia-broadcast", CategoryType: "gaming", Description: "NVIDIA AI-powered video and audio broadcast tool."},
			},
		},
		{
			Name:         "Utilities",
			...
			Categories: []Category{
				...
				},
				{
					...
					Apps: []Package{
						...
						{Name: "Rufus", PackageID: "rufus", CategoryType: "utility", Description: "Bootable USB drive creator."},
						...
						{Name: "Process Hacker", PackageID: "processhacker", CategoryType: "utility", Description: "Advanced process viewer and system monitor."},
				...
				},
				{
					...
					Apps: []Package{
						...
						{Name: "ProtonVPN", PackageID: "protonvpn", CategoryType: "security", Description: "Proton VPN desktop client."},
					},
				},
				{
				...
				},
				{
					...
					Apps: []Package{
						...
						{Name: "VMware Workstation", PackageID: "vmwareworkstation", CategoryType: "virtualization", Description: "VMware desktop virtualization platform."},
					},
				},
			},
		},
