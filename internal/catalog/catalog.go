	...
	categories := []Category{
		{
			...
			Apps: []Package{
				...
				detect(app("LibreWolf", "librewolf", "browser", "Privacy-focused Firefox fork."), DetectRegistry, "LibreWolf"),
			...
			Categories: []Category{
				{
					...
					Apps: []Package{
						...
						detect(app("HandBrake", "handbrake", "media", "Video transcoder and converter."), DetectRegistry, "HandBrake"),
