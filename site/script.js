const packageCatalog = [
  ...
  ["MinGW", "mingw"],
  ["CMake", "cmake"],
  ["VC++ Redist 2005 x86/x64", "vcredist2005"],
  ["VC++ Redist 2008 x86/x64", "vcredist2008"],
  ["VC++ Redist 2010 x86/x64", "vcredist2010"],
  ["VC++ Redist 2012 x86/x64", "vcredist2012"],
  ["VC++ Redist 2013 x86/x64", "vcredist2013"],
  ["VC++ Redist 2015 x86/x64", "vcredist2015"],
  ["VC++ Redist 2017 x86/x64", "vcredist2017"],
  ["VC++ Redist 2015-2026 x86/x64", "vcredist140"],
  ...
  ["VMware Workstation", "vmwareworkstation"],
]
  .map(([name, id]) => ({ name, id }))
